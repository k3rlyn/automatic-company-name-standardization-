...
def standardize_company_name(company_name, model):
    ...
    - "BCA Digital" → "PT Bank Digital BCA"
    - "BTPN" → "PT Bank Tabungan Pensiunan Nasional Tbk"
    - "PT Bank BPTN" → "PT Bank Tabungan Pensiunan Nasional Tbk"
    ...
    - "BI" `→ "Bank Indonesia"
    - "Telkom" → "PT Telkom Indonesia Tbk"
    - "Pertamina" → "PT Pertamina (Persero)"
    - "Pertamina Hulu Rokan" → "PT Pertamina Hulu Rokan"
    - "PHR" → "PT Pertamina Hulu Rokan"
    - "Schlumberger" → "PT Schlumberger Indonesia"
    - "Halliburton" → "PT Halliburton Indonesia"
    - "Weatherford" → "Weatherford Indonesia"
    - "Skintific" → "PT May Sun Yvan"
    ...
    - "Ecoedu" → "PT Eco Edu Indonesia"
    - "CV. XOSO" → "CV XOSO"
    - "Bonvie" → "Bonvie (PT Kreasi Semangat Muda)"
    - "BTPN" → "PT Bank Tabungan Pensiunan Nasional Tbk"
    - "Mandiri" → "PT Bank Mandiri (Persero) Tbk"
    - "BRI" → "PT Bank Rakyat Indonesia (Persero) Tbk"
    - "BNI" → "PT Bank Negara Indonesia (Persero) Tbk"
    ...
    - "Weatherford" → "Weatherford Indonesia"
    - "Skintific" → "PT May Sun Yvan"
    - "Shopee" → "PT Shopee Internasional Indonesia"
    - "White.id" → "WIT.id"
    - "Ninja Xpress"  → "NinjaXpress"
    - "PUPR" → "Pekerjaan Umum dan Perumahan Rakyat"
    - "Accenture" → "PT Accenture Indonesia"
    - "ABeam Consulting" → "PT ABeam Consulting Indonesia"
    - "Adira Finance" → "PT Adira Dinamika Multi Finance Tbk."
    - "Agate" → "PT Agate International"
    - "Akulaku" → "PT Akulaku Silvrr Indonesia"
    - "Allianz" → "PT Asuransi Allianz Life Indonesia"
    - "Alodokter" → "PT Alodokter Teknologi Solusi"
    - "Ameliore" → "PT Ameliore Solusi Analitika"
    - "Annisa Surya Kencana" → "PT Annisa Surya Kencana"
    - "AMF" → "Anwar Muhammad Foundation"
    - "Anugerah Samudera Madanindo" → "PT Anugerah Samudera Madanindo"
    - "Arayya Tama Mandiri" → "PT Arayya Tama Mandiri"
    - "Arwana Citramulia" → "PT Arwana Citramulia Tbk."
    - "Asahimas Chemical" → "PT Asahimas Chemical"
    - "Aurecon Indonesia" → "PT Aurecon Indonesia"
    - "PwC" → "PricewaterhouseCoopers"
    - "Ruangguru" → "Ruangguru (PT Ruang Raya Indonesia)"
    - "CAD IT" → "CAD-IT Consultants Asia Pte Ltd (Indonesia Representative Office)"
    - "Bukalapak" → "PT Bukalapak.com Tbk"
    - "Bonvie" → "PT Kreasi Semangat Muda"
    - "Ecomindo" → "PT Ecomindo Saranacipta"
    - "National Urban Water Supply Project (NUWSP) Kementerian PUPR" → "National Urban Water Supply Project Kementerian Pekerjaan Umum dan Perumahan Rakyat"
    - "Bumi Resources Minerals" → "PT Bumi Resources Minerals Tbk"
    - "Toyota Astra Motor" → "PT Toyota-Astra Motor"
    - "Pinhome" → "PT Properti Solusi Manajemen"
    - "PT Tungal Inti Kahuripan" → "PT Tunggal Inti Kahuripan"
    - "Oy!" → "PT Dompet Harapan Bangsa"
    - "Schlumbergerz" → "PT Schlumberger Geophysics Nusantara"
    - "Blibli" → "Blibli (PT Global Digital Niaga)"
    - "APRIL Group" → APRIL GROUP (PT Riau Andalan Pulp & Paper)
    - "PT Riau Andalan Pulp & Paper" → APRIL GROUP (PT Riau Andalan Pulp & Paper)
    - "OVO" → "OVO (PT Visionet Internasional)"
